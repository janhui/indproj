package com.example.josekalladanthyil.myapplication.Canvas;
...
public class CanvasView extends View {
    ...
    public CanvasView(Context context, Firebase ref) {
        super(context);
        ...
        this.setMinimumHeight(height + 300);
        this.setMinimumWidth(width + 300);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        height = heightMeasureSpec +300;
        width = widthMeasureSpec+300;
